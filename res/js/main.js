...
const portalsWarningContinue = document.getElementById(
  "portalsWarningContinue"
);
...
thehell.onclick = () => {
  ...
  const myInterval = setInterval(() => {
    ...
    if (enemy1HP.innerText <= 0) {
      ...
      draezlyrImage.style.animation =
        "powerOfHellDraezlyr 1s infinite alternate linear";
      ...
      logo.style.textShadow =
        "1px 1px 2px rgb(255, 255, 255), 0 0 1em #F11514, 0 0 0.2em #F11514";
  ...
  if (yourXP >= 150) {
    ...
    const myInterval = setInterval(() => {
      ...
      if (enemy1HP.innerText <= 0) {
        ...
        draezlyrImage.style.animation =
          "powerOfHeavenDraezlyr 1s infinite alternate linear";
        ...
        logo.style.textShadow =
          "1px 1px 2px rgb(255, 255, 255), 0 0 1em #bdb643, 0 0 0.2em #bdb643";
